...
const apiKey = 'ccef2cf2604e73ad700d3aaae268f483'
...
cityInput.addEventListener('keydowmn', (event) => {
  if (event.key == 'Entre' &&
...
function getweatherIcon(id){
  if (id <= 232) return './image/tunderstrom.jpeg'
  if (id <= 321) return './image/drizzle.jpeg'
  if (id <= 531) return './image/rains.jpeg'
  if (id <= 622) return './image/Snow.jpeg'
  if (id <= 781) return './image/atmosphere.jpeg'
  if (id <= 800) return './image/clears.jpeg'
  else return './image/clouds.jpeg'
}
...
function updateForecastItems(weatherData){
  ...
  const forecastItem = `
    <div class="forecast-item">
      ...
      <img src="${getweatherIcon(id)}" alt="logo" class="forecast-item-img">
